...
describe("<BarChartWrapper />", () => {
  ...
  it("sets correct canvas settings", () => {
    ...
    const canvasSettings = canvasSetupFactory(options, "bar", "percent");
    expect(canvasSettings.indexAxis).toBe(expectedResult.indexAxis);
    // @ts-ignore
    expect(canvasSettings.scales.x.title.text).toBe(
      expectedResult.scales.x.title.text,
    );
    // @ts-ignore
    ...
    // @ts-ignore
    expect(canvasSettings.scales.y.title.text).toBe(
      expectedResult.scales.y.title.text,
    );
    // @ts-ignore
