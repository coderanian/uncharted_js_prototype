...
export default {
    title: 'Example/Chart/CombinedChartWrapper',
    component: CombinedChartWrapper,
    parameters: {
        layout: 'centered',
    },
    tags: ['autodocs'],
} satisfies Meta<typeof CombinedChartWrapper>;

const Template: Story<ICombinedChart> = (args: ICombinedChart) => <CombinedChartWrapper {...args} />;
...
Loaded.args = {
    ...
    options: {
        ...
        yRightAxisTitle: 'Shipment count'
    },
    yRightFormat: 'percent',
    yLeftFormat: 'euro',
    barKeys: ['on_time_delivery_percent', 'tracking_rate_percent' ],
    lineKeys: ['shipment_count']
};
